...
export function CapybaraStage({
  ...
  return (
    <div className="relative flex aspect-square w-36 shrink-0 items-center justify-center overflow-hidden rounded-2xl border-[3px] border-slate-900 bg-[#dff5e1] sm:w-56">
